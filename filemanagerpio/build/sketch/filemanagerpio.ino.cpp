#include <Arduino.h>
#line 1 "c:\\Users\\JanShahid\\Desktop\\filemanagerpio\\filemanagerpio.ino"
/*
...
#line 16 "c:\\Users\\JanShahid\\Desktop\\filemanagerpio\\filemanagerpio.ino"
void setup();
#line 50 "c:\\Users\\JanShahid\\Desktop\\filemanagerpio\\filemanagerpio.ino"
void loop();
#line 16 "c:\\Users\\JanShahid\\Desktop\\filemanagerpio\\filemanagerpio.ino"
void setup()
{
  ...
  if ((millis() - lastFetchTime) >= FETCH_INTERVAL || Start)
  {
    ...
    if (allData.containsKey("Departure")) {
      ...
      if (UpdateFlightsBatch("Departure", batchFlights)) {
        Serial.println("✅ DEPARTURE flights uploaded successfully!");
      } else {
        Serial.println("❌ Failed to upload DEPARTURE flights");
      }
    }
    ...
    if (allData.containsKey("Arrival")) {
      ...
      if (UpdateFlightsBatch("Arrival", batchFlights)) {
        Serial.println("✅ ARRIVAL flights uploaded successfully!");
      } else {
        Serial.println("❌ Failed to upload ARRIVAL flights");
      }
    }
    
    allData.clear();

    Serial.println("✅ Sync cycle complete - waiting for next cycle (5 minutes)\n");
