#line 1 "c:\\Users\\JanShahid\\Desktop\\filemanagerpio\\Global.h"
#ifndef GLOBAL_H
#define GLOBAL_H
...
#define FIREBASE_DATABASE_URL "https://aseengrs-7f20c-default-rtdb.asia-southeast1.firebasedatabase.app"
...
// ============ HELPER FUNCTIONS ============
// List of allowed keys to keep in Firebase cache
extern const char* allowedKeys[];
extern const int allowedKeysCount ;
extern bool Start;
// ============ NTP TIME FUNCTIONS ============
void NTP_Init();
...
// DNS server used for captive portal (redirect all DNS queries to the ESP AP IP)
...
void parseFlightTableRow(String tableRowHtml, JsonDocument& doc, String category, String subCategory);
